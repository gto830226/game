...
export class Level2 extends Level {
  ...
  public initSprites(cameras: Camera[]) {
    ...
    let p1 = new People({ up: 'w', down: 's', left: 'a', right: 'd', rotate: 'z' }, 200, 400);
    let p2 = new People({ up: 'ArrowUp', down: 'ArrowDown', left: 'ArrowLeft', right: 'ArrowRight', rotate: ' ' }, 500, 200);
